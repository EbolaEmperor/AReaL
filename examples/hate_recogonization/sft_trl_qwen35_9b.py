"""
SFT fine-tuning of Qwen3.5-9B using TRL's SFTTrainer + LoRA.
LoRA r=32 alpha=64 on all linear layers, lr 2e-4, cosine, 3 epochs.

Launch (single GPU):
    CUDA_VISIBLE_DEVICES=0 python examples/hate_recogonization/sft_trl_qwen35_4b.py
"""
...
OUTPUT_DIR = "/tmp/areal/experiments/checkpoints/wenchong/hate-recognition-sft-qwen35-9b"
...
def main():
    ...
    model = AutoModelForCausalLM.from_pretrained(
        ...
        device_map="auto",  # spread across 2 GPUs for 9B model
    )
